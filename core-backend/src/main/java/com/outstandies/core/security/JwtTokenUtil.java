...
public class JwtTokenUtil implements Serializable {
    ...
    public Date getIssuedAtDateFromToken(String token) {
    	System.out.println("JwtTokenUtil.getIssuedAtDateFromToken()");
    ...
    public String getAudienceFromToken(String token) {
    	System.out.println("JwtTokenUtil.getAudienceFromToken()");
    ...
    private Boolean isCreatedBeforeLastPasswordReset(Date created, Date lastPasswordReset) {
    	System.out.println("JwtTokenUtil.isCreatedBeforeLastPasswordReset()");
        return (lastPasswordReset != null && created.before(lastPasswordReset));
    }

    private String generateAudience(Device device) {
    	System.out.println("JwtTokenUtil.generateAudience()");
    ...
    public String refreshToken(String token) {
    	System.out.println("JwtTokenUtil.refreshToken()");
        final Date createdDate = clock.now();
        final Date expirationDate = calculateExpirationDate(createdDate);
